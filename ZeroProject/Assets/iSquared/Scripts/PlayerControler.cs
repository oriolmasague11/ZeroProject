...
{
    [Header("Screen Parameters"), Tooltip("These data are duplicated and they not should be!")]
    [SerializeField] private float horizontalLimit = 9.5f + 0.5f;
    [SerializeField] private float verticalLimit = 9.5f + 0.5f;
    ...
    private void LateUpdate()
    {
        ...
        float size = _transform.localScale.x;
        float xLimit = (horizontalLimit - size * 0.5f);
        float yLimit = (verticalLimit - size * 0.5f);
